...
/// Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (ctx)=>newPage));
navigatorPushReplacement(context, newPage) async {
  return Navigator.of(context)
      .pushReplacement(MaterialPageRoute(builder: (ctx) => newPage));
}
